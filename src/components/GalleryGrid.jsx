...
const GalleryGrid = () => {
  const images = [
    { src: '/pironne.avif', span: 'col-span-2' },
    { src: '/7A54B0F5-01DB-40AD-A163-B2CBF0F8C472_1_105_c.jpeg', span: 'col-span-1' },
    { src: '/pironne4.jpg', span: 'col-span-1 row-span-2'},
    { src: '/pironne2.jpg', span: 'col-span-1' },
    { src: '/pironne3.jpg', span: 'col-span-1 hidden lg:block' }, 
    { src: '/pironne5.jpg', span: 'col-span-2' },
  ];
