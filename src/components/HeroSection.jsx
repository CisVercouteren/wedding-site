...
const HeroSection = () => {
    return (
        <section id="Hero" className="w-screen flex flex-wrap lg:flex-row justify-center items-center xl:h-[80vh] lg:pt-10 bg-cream">
            ...
            <PhotoCard title="wat" className="lg:w-1/4 lg:min-w-1/4" src="/cis_ine_walk.jpeg" subtitle="Trouw Cis & Ine"/>
            <PhotoCard title="waar" className="lg:w-1/4 lg:min-w-1/4" src="/chateau-pironne.jpg" subtitle="Chateau Pironne"/>
        </section>
    )
}
